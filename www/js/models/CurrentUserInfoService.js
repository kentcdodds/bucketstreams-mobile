angular.module('bs.models').factory('CurrentUserInfoService', function($rootScope, $q, $http, _, User, BASE_URL, Stream, Bucket) {
  var things = {
    authenticated: {
      val: null,
      ...
      refresher: function() {
        ...
        $http.get(BASE_URL + '/api/v1/auth/isAuthenticated').then(function(response) {
